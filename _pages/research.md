...
<div style="display: flex; flex-wrap: wrap; gap: 20px; align-items: stretch; margin-bottom: 13px; background: linear-gradient(135deg, #eef6fb 0%, #f7fbfe 100%); border: 1px solid #c7ddeb; border-radius: 18px; padding: 18px;">
  <div style="flex: 0 1 540px; min-width: 400px; display: flex;">
